...
const mockRows: TsMimu[] = [
  {
    id: "1",
    created_at: "2026-01-19 03:52:33",
    title_english: "Falam",
    title_myanmar: "ဖလမ်း",
  },
]

type SortField = keyof TsMimu
...
export default function TsMimuPage() {
  const [rows, setRows] = useState<TsMimu[]>(mockRows)
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Townships (ts_mimu)" />
