...
export default function DataTypePage() {
  ...
  useEffect(() => {
    const fetchRows = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error("Failed to fetch Data Type records")
        }
        ...
        console.error(error)
        alert("Failed to load Data Type records")
      } finally {
        setLoading(false)
      }
    }
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Data Type" />
                ...
                currentItems.map((row) => (
                  ...
                  >
                    ...
                    <TableCell className="px-5 py-4">
                      <Link href={`/data_type/edit/${row.id}`}>
