...
const mockRows: TeacherStatus[] = [
  {
    id: "1",
    created_at: "2026-01-19 04:56:08",
    title_english: "Stay",
    title_short: "S",
    title_myanmar:
...
type SortField = keyof TeacherStatus
...
export default function TeacherStatusPage() {
  const [rows, setRows] = useState<TeacherStatus[]>(mockRows)
  ...
  const handleDelete = (id: string) => {
    if (confirm("Delete this teacher status?")) {
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Teacher Status" />
                ...
                >
                  ...
                  <TableCell className="px-5 py-4">
                    <div className="flex items-center gap-2">
                      <Link href={`/teacher_status/edit/${r.id}`}>
