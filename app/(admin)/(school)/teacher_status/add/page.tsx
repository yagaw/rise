...
export default function AddTeacherStatus() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: call API to create teacher status
    alert(`Create teacher status: ${titleEnglish}`)
  }

  return (
    <div>
      <PageBreadcrumb pageTitle="Add Teacher Status" />
